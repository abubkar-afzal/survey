    ...
    <>
      <div className="sm:flex sm:fixed  sm:z-10 w-[100vw]">
        <div className="py-2 pl-2 grid grid-cols-2  ">
            <div className="sm:relative sm:z-10 t:hidden">
            <div
          ...
          >
            ...
            <Link href={`http://localhost:3000/components/home`}>
              <div
        ...
        <div className="sticky left-0 ">
          <div className="">
            <Image src={Logo} alt="logo" height={100} width={300} className="sm:ml-[10px] mm:ml-[20px] lm:ml-[30px] t:ml-[8px] t:w-[150px] t:h-[130px] cursor-pointer l:w-[200px] l:h-[170px] ll:w-[250px] ll:h-[210px] k:w-[400px] k:h-[320px] my:ml-[50px]" />
          </div>
       </div>
        ...
        <Link href={`http://localhost:3000/components/home`}>
            ...
            >
              ...
              >
                ...
                />
                <p  className={`pr-[10px] k:pr-[20px] ${showaccount}`}>Account</p>
              </div>
            </Link>
            <Link href={`http://localhost:3000/components/login`}>
              <div
          ...
          <div className="grid content-center items-center grid-cols-3 w-[8rem] h-[2rem] rounded-[2rem] border-[1.5px] border-black absolute sm:top-6 sm:right-2 mm:top-8 mm:right-2 lm:top-8 lm:right-2 t:top-8 t:w-[7rem] t:h-[1.8rem] l:w-[9rem] my:right-10 l:h-[2.5rem] ll:h-[3.3rem] ll:w-[12rem] k:w-[18rem] k:h-[7rem]">
            ...
            <input 
              type="text"
              className=" sm:w-[5rem] sm:h-[1rem] sm:place-self-between bg-transparent t:w-[4rem] t:h-[0.8rem] l:w-[5rem] l:h-[1.3rem] ll:w-[6rem] ll:h-[2.3rem] k:w-[11rem] k:h-[6rem] k:text-[3rem]"
              name="search"
              id="search"
              placeholder="search"
            />
