...
const Navbar = ({ accountlogo }) => {
  ...
  if (currentUrl === "/") {
    ...
    currentUrl === "/components/about" ||
    currentUrl.includes("about")
  ) {
    about = "sm:text-[---c4] sm:bg-[---c3]";
  } else if (
    currentUrl === "/components/blogs" ||
    currentUrl.includes("blogs") ||
    currentUrl.includes("/components/slug/")
  ) {
    ...
    currentUrl === "/components/account" ||
    currentUrl.includes("account")
  ) {
    account = "sm:text-[---c4] sm:bg-[---c3]";
    laccount = true;
  } else if (currentUrl === "/admin" || currentUrl.includes("admin")) {
  ...
  return (
    <>
     ...
     sm:z-10 w-[100vw] bg-[---c4] "
          ...
          >
            <Link href={`${process.env.NEXT_PUBLIC_HOST}/`}>
              ...
              >
                ...
                <p
                  spellCheck="true"
                  className={`${showhome} pr-[10px] k:pr-[20px]`}
                >
                  Home
                </p>
              </div>
            ...
            <Link href={`${process.env.NEXT_PUBLIC_HOST}/components/about`}>
              ...
              >
                ...
                <p
                  spellCheck="true"
                  className={`pr-[10px] k:pr-[20px] ${showabout}`}
                >
                  About
                </p>
              </div>
            ...
            <Link href={`${process.env.NEXT_PUBLIC_HOST}/components/blogs`}>
              ...
              >
                ...
                <p
                  spellCheck="true"
                  className={`pr-[10px] k:pr-[20px] ${showblogs}`}
                >
                  Blogs
                </p>
              </div>
            ...
            { accountlogo ?
             (loader ? (
              ...
              >
                <div
                  spellCheck="true"
                  className={` sm:cursor-pointer sm:hover:bg-[---c3] sm:active:bg-[---c6]      sm:items-center sm:hover:text-[---c4] sm:active:text-[---c4] sm:font-extrabold   ${
                    laccount
                      ? "t:w-[16vw] l:w-[16vw] t:h-[7vh] l:h-[8vh] ll:h-[11vh] k:h-[17vh] t:bg-[---c3] t:text-[---c4]"
                      : "t:w-[2rem] t:h-[2rem] l:w-[3rem] ll:w-[4rem] ll:h-[4rem] l:h-[3rem] k:w-[7rem] k:h-[7rem]"
                  }  sm:rounded-[2rem]  sm:flex sm:space-x-1`}
                >
                  <Image
                    src={dphoto}
                    alt="logo of account"
                    className={` l:w-[3rem] ll:w-[4rem] ll:h-[4rem] k:w-[7rem] k:h-[7rem]  l:h-[3rem] t:w-[2.5rem] t:h-[2.5rem] sm:active:bg-[---c6] h-[1.5rem] text-[---c2] sm:active:text-[---c4] sm:rounded-[2rem] sm:hover:text-[---c4]  ${account}`}
                  />
                  <p
                    spellCheck="true"
                    className={`pr-[10px] k:pr-[20px] ${showaccount}`}
                  >
                    Account
                  </p>
                </div>
              ...
              <Link href={`${process.env.NEXT_PUBLIC_HOST}/components/login`}>
                ...
                >
                  ...
                  <p
                    spellCheck="true"
                    className={`pr-[10px] k:pr-[20px] ${showlogin}`}
                  >
                    Login
                  </p>
                </div>
            ...
            <Link href={`${process.env.NEXT_PUBLIC_HOST}/admin`}>
              ...
              >
                ...
                <p
                  spellCheck="true"
                  className={`pr-[10px] k:pr-[20px] ${showadmin}`}
                >
                  Admin
                </p>
              </div>
      ...
      <div
        spellCheck="true"
        className="h-[5rem] w-[100%] bg-[---c4] l:h-[7rem] ll:h-[8.5rem] k:h-[13rem]"
      ></div>
    </>
  );
};
