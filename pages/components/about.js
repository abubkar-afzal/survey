  ...
  return (
    <>
      <div className="m-4 space-y-2 text-justify">
        <div className="text-center sm:text-[25px] font-sans">
          It's <a className="sm:text-[---c5] font-black ">Abubakar Afzal </a>.
        </div>
        <div className="text-center sm:text-[12px] font-semibold">
        ...
        <p className="sm:my-2 sm:h-[12rem] overflow-y-scroll bg-[---c8] p-2 text-[---c4]">
