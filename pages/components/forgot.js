  ...
  return (
    <><Fade cascade>
     <div spellCheck="true" className="">
        <div spellCheck="true" className="sm:text-center mm:mt-[1rem] t:mt-[2rem]">
          ...
          <div spellCheck="true" className=" sm:text-center sm:font- my-2 pt-[3rem] bg-[---c8] rounded-[2rem] mx-[1rem] text-[---c4] sm:h-auto sm:space-y-[2rem] font-semibold items-center place-items-center place-content-start p-[2rem]   ">
            <div spellCheck="true">
              <div spellCheck="true" className=" sm:text-[22px] mm:text-[26px] lm:text-[30px] t:text-[42px] l:text-[49px] ll:text-[55px] k:text-[85px] mb-2">Forgot Password !!</div>
      ...
      focus:outline-none focus:border-black focus:ring-2 focus:ring-black focus:bg-[---c4] focus:text-black focus:placeholder-black "
            ...
            <button spellCheck="true" className="bg-[---c5] hover:bg-[---h5] p-2 mb-2 w-[8rem] rounded-[2rem] font-bold shadow-lg text-[---c4] sm:text-[16px] mm:text-[18px] lm:text-[22px] t:text-[27px] l:text-[32px] ll:text-[37px] k:text-[45px]">
                Check
              </button>
          </div>
        </div></Slide>
