    ...
    <>
      ...
      >
        <div className="items-center text-center rounded-[2rem] bg-[---c2] xsm:mx-[2rem] sm:mx-[1px] shadow-lg">
          <iframe
            className="rounded-[2rem] w-full sm:h-[40vh] xsm:h-[25vh]"
            src="https://www.youtube.com/embed/HUX6JvHrE5g?autoplay=1&mute=1"
            frameborder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowfullscreen
          ></iframe>
          <h2 className=" text-white font-black p-4 rounded-[2rem] sm:text-[20px] xsm:text-[16px] m-4 ">
            This is Tutorial That How to Give Answer First Time ..!!
          </h2>
          <button
            onClick={closeModal}
            className="bg-[---c7] text-white font-black p-4 rounded-[1.5rem] sm:text-[20px] xsm:text-[14px] m-4"
          >
            Ok..!!
          </button>
        </div>
      ...
      <Fade cascade className={`${open ? "blurred-background" : null}`}>
        <div spellCheck="true" className="">
          <div
            spellCheck="true"
            className=" m-4 space-y-2 ll:space-y-[1.5rem] k:space-y-[2rem]  text-justify t:p-4  k:p-10  l:text-center l:place-items-center l:p-10  k:text-center k:place-items-center "
          >
            <div
              spellCheck="true"
              className="text-center sm:text-[22px] mm:text-[24px] lm:text-[29px] t:text-[34px] l:text-[39px] ll:text-[44px] k:text-[64px]  font-sans font-bold"
            >
              HI! There It's
            </div>
            <div
              spellCheck="true"
              className="font-bold sm:mb-[2rem] sm:text-[2rem] text-center"
            >
            ...
            <div
              spellCheck="true"
              className="sm:bg-[---c2] sm:text-[---c4] sm:font-bold p-2 sm:h-[8rem] sm:overflow-y-scroll text-center scroll-auto mm:text-[18px] lm:text-[20px] t:text-[20px] l:text-[25px] ll:text-[30px] k:text-[35px] ll:w-[70rem] t:mx-auto hidebar"
            >
              <p spellCheck="true">
                First I want to .
                ...
                <a className="sm:text-[---c5] font-black">Statistics</a>.
                Part_II in .
                <Link
              ...
              <p
                spellCheck="true"
                className="mt-[8px] pb-2 sm:text-[18px] mm:text-[18px] lm:text-[20px] t:text-[22px] l:text-[27px] ll:text-[32px] k:text-[37px]"
              >
                This is a <a className="sm:text-[---c7] font-black">Survey</a>{" "}
                by which I got some answers of common questions. These questions
                always make somes problems in every one life.
              </p>
            </div>
            <div
              spellCheck="true"
              className="sm:text-[24px] sm:text-center sm:font-[bold] mt-6 mm:text-[28px] lm:text-[30px] t:text-[35px] l:text-[38px] ll:text-[42px] k:text-[50px]"
            >
            ...
            <div
              spellCheck="true"
              className="sm:text-[17px] sm:text-center sm:font- my-2 mm:text-[16px] lm:text-[18px] t:text-[22px] l:text-[27px] ll:text-[32px] k:text-[37px]"
            >
            ...
            {display ? (
                ...
                return (
                  <Slide triggerOnce duration={2000}>
                    <div spellCheck="true" key={item._id} className="h-auto">
                      <div
                        spellCheck="true"
                        className="my-[2rem] t:w-[30rem] l:w-[35rem] mx-auto text-center shadow-sm shadow-black rounded-[2rem] p-2 t:p-6 bg-[---c8] sm:text-[---c4] space-y-[10px] mm:space-y-[15px] lm:space-y-[20px] t:space-y-[22px] l:space-y-[27px] ll:space-y-[32px] k:space-y-[40px] "
                      >
                        <div
                          spellCheck="true"
                          className="font-bold sm:text-[20px] mm:text-[27px] lm:text-[30px] t:text-[28px] l:text-[33px] ll:text-[38px] k:text-[47px] "
                        >
                          {item.question_title}
                        </div>
                        <div spellCheck="true">
                        ...
                        <p
                          spellCheck="true"
                          className="text-[17px] sm:text-[18px] mm:text-[22px] lm:text-[25px] t:text-[22px] l:text-[27px] ll:text-[32px] k:text-[37px] font-semibold "
                        >
                          {item.question_label}
                        </p>
                        <input
              ...
              <div
                spellCheck="true"
                className="mx-auto mt-[60vh] mb-[40vh] justify-items-center"
              >
                <DotLoader
                ...
                <p
                  spellCheck="true"
                  className="font-bold sm:text-[18px] mm:text-[18px] lm:text-[20px] t:text-[22px] l:text-[27px] ll:text-[32px] k:text-[37px]"
                >
                  Please Wait !!
                </p>
              </div>
            ...
            {thanks ? (
              <div
                spellCheck="true"
                className=" text-center text-wrap rounded-[2rem] p-2"
              >
            ...
            <div spellCheck="true">
              <p
                spellCheck="true"
                className="text-center  mt-[25px] text-[1.4rem] font-[bold] sm:text-[16px] mm:text-[22px] lm:text-[26px] t:text-[22px] l:text-[27px] ll:text-[32px] k:text-[37px]"
              >
                Do you give all answers !!
              </p>
              <div
                spellCheck="true"
                className="text-center sm:text-[16px] mm:text-[20px] lm:text-[24px] t:text-[22px] l:text-[27px] ll:text-[32px] k:text-[37px]"
              >
                <button
                  spellCheck="true"
                  disabled={dyes}
          ...
          {yesModal ? (
            <Fade cascade>
              <div
                spellCheck="true"
                className="m-4 sm:mt-[-8rem] mm:mt-[-8.5rem] lm:mt-[-9rem] t:mt-[-10rem] l:mt-[-12rem] ll:mt-[-13rem] relative"
              >
            ...
            <Fade cascade>
              ...
              >
                <div spellCheck="true" className="h-auto">
                  <div
                    spellCheck="true"
                    className="my-[2rem] t:w-[30rem] l:w-[35rem] mx-auto text-center shadow-sm shadow-black rounded-[2rem] p-2 t:p-6 bg-[---c7] sm:text-[---c4] space-y-[10px] mm:space-y-[15px] lm:space-y-[20px] t:space-y-[22px] l:space-y-[27px] ll:space-y-[32px] k:space-y-[40px] "
                  >
                    <div
                      spellCheck="true"
                      className="font-bold sm:text-[20px] mm:text-[27px] lm:text-[30px] t:text-[28px] l:text-[33px] ll:text-[38px] k:text-[47px] "
